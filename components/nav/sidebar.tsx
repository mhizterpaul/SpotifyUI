...
const Sidebar = (params: { isOpen?: boolean }) => {
    ...
    return (<nav className={/*my-auto */ `bg-black sidebar hidden sm:flex flex-col h-[91vh] min-h-[584px] items-center max-h-[696px] justify-around
        ...
        <ul>
            <li onClick={() => dispatch(pushRef('/create_playlist'))}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 16 16"><path fill="currentColor" fillRule="evenodd" d="M4 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H4Zm4 9a.75.75 0 0 1-.75-.75v-1.5h-1.5a.75.75 0 0 1 0-1.5h1.5v-1.5a.75.75 0 0 1 1.5 0v1.5h1.5a.75.75 0 0 1 0 1.5h-1.5v1.5A.75.75 0 0 1 8 11Z" clipRule="evenodd" /></svg> Create Playlist</li>
            <li onClick={() => dispatch(pushRef('/liked_songs'))}>
                ...
                liked songs</li>
            <li onClick={() => dispatch(pushRef('/episodes'))}>
