...
const Sidebar = (params: { isOpen?: boolean }) => {
    ...
    let className = keysLength ? 'absolute ' + (params.isOpen ? 'translateOut' : 'translateIn') : '';

    if (params.isOpen === undefined && keysLength) return null;
    ...
    return (<nav className={/*my-auto */ `bg-black sidebar
        ...
        <ul>
            <li onClick={() => dispatch({ type: '/' })}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M6 21q-.825 0-1.413-.588T4 19v-9q0-.475.213-.9t.587-.7l6-4.5q.275-.2.575-.3T12 3.5q.325 0 .625.1t.575.3l6 4.5q.375.275.588.7T20 10v9q0 .825-.588 1.413T18 21h-4v-7h-4v7H6Z" /></svg> Home
            </li>
            <li onClick={() => dispatch({ type: '/search' })}>
            ...
            <li onClick={() => dispatch({ type: '/library' })}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M7 3h2v18H7zM4 3h2v18H4zm6 0h2v18h-2zm9.062 17.792l-6.223-16.89l1.877-.692l6.223 16.89z" /></svg> Your library</li>
        </ul>
        <ul>
            <li onClick={() => dispatch({ type: '/create_playlist' })}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 16 16"><path fill="currentColor" fillRule="evenodd" d="M4 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H4Zm4 9a.75.75 0 0 1-.75-.75v-1.5h-1.5a.75.75 0 0 1 0-1.5h1.5v-1.5a.75.75 0 0 1 1.5 0v1.5h1.5a.75.75 0 0 1 0 1.5h-1.5v1.5A.75.75 0 0 1 8 11Z" clipRule="evenodd" /></svg> Create Playlist</li>
            <li onClick={() => dispatch({ type: '/liked_songs' })}>
                ...
                liked songs</li>
            <li onClick={() => dispatch({ type: '/episodes' })}>
