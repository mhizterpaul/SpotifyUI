...
const Profile = ({ className }: { className: string }) => {
    ...
    return (
        <button className={className + ' max-w-[8rem] w-1/4 h-10 relative flex flex-row items-center justify-between bg-black rounded-2xl sm:mr-0 mr-16'}
            onClick={handleClick}>
            ...
            <ul className={'absolute bg-gray-900 top-10 left-0 w-full rounded-b-xl z-10' + ' ' + state.display} onClick={handleClick}>
