const PlayIcon = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className={` relative group w-fit h-fit`}>
            {children}
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" className={`hidden h-[42%] w-auto text-[#1ed760] z-10 absolute bottom-[4%] right-[5%] group-hover:block shadow rounded-full 
