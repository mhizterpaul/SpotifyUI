...
const Footer = () => {
    ...
    return (<footer className={`${nowPlaying?.album?.image || nowPlaying?.track?.album.image || nowPlaying?.image || nowPlaying?.show?.image ? '' : ' inactive '}` + ' footer bg-[#181818] w-screen relative flex items-center justify-between z-10 whitespace-nowrap pb-6 -mt-12 md:min-w-[540px] min-h-[120px] h-[14vh] gap-x-2 overflow-visible'}>
